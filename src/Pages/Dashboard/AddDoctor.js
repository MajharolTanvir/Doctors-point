...
const AddDoctor = () => {
    ...
    const { data: services, isLoading } = useQuery('services', () => fetch('https://gentle-basin-92445.herokuapp.com/service').then(res => res.json()))
        ...
        fetch(url, {
            ...
            .then(result => {
                if (result.success) {
                    ...
                    console.log(doctor);
                    fetch('https://gentle-basin-92445.herokuapp.com/doctor', {
                        method: 'POST',
                        headers: {
