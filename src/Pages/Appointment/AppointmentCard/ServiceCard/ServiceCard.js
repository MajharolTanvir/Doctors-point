        ...
        <div className="card w-full shadow-xl my-10">
            <div className="card-body text-center">
                ...
                <div className="card-actions justify-center"><button></button>
                    <label onClick={() => setTreatment(service)} htmlFor="Booking-modal" disabled={slots.length === 0} className="btn bg-gradient-to-r from-secondary to-primary font-bold text-white">BOOK APPOINTMENT</label>
                </div>
            </div>
        </div>
    );
